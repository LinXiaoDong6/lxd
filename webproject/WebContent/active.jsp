...
<html>
	...
	<body bgcolor="#ffffff">
		<table width="785" height="117" border="0" align="center"
			...
			<c:forEach items="${sessionScope.page1.list }" var="act">
			<tr>
			...
			<tr>
				<td width="786" height="30" colspan="9" align="right">
					...
					<table width="786" align="center" cellpadding="0" cellspacing="0">
						<tr>
							<td width="786" height="30" colspan="9" align="right">
								共${sessionScope.page1.totalPages }页
								<a href="ActiveServlet?act=1&num=1">第一页</a>
								
								<a href="ActiveServlet?act=1&num=${sessionScope.page1.currPagenum-1>0?sessionScope.page1.currPagenum-1:1 }">上一页</a>
								
								<a href="ActiveServlet?act=1&num=${sessionScope.page1.currPagenum+1<sessionScope.page1.totalPages?sessionScope.page1.currPagenum+1:sessionScope.page1.totalPages }">下一页</a>
								
								<a href="ActiveServlet?act=1&num=${sessionScope.page1.totalPages }">最后一页</a>
								<span class="bgcolor"> <input name="topage" type="text"
										class="txt_grey" size="3" value="${sessionScope.page1.currPagenum }">页</span>
							</td>
						</tr>
					</table>
				</td>
